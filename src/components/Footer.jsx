        ...
        <footer className="style-2">
            <div className="footer-top dark-view padding-tb">
                <div className="container">
                    <div className="row g-4 row-cols-md-2 row-cols-lg-4 row-cols-1">
                        <div className="col">
                                ...
                                <div className="footer-inner">
                                    <div className="footer-content">
                                        ...
                                        <div className="content">
                                            <p>{desc}</p>
                                            <ul className="lab-ul offfice-address">
                                                {
                                            ...
                                            <ul className="lab-ul social-icons">
                                                {
                                                    socialList.map((item, key) => (
                                                        <li key={key}>
                                                            <a href={item.siteLink} className={item.className}><i className={item.iconName}></i></a>
                                                        </li>
                                                    ))
                                                }
                                            </ul>
            ...
            <div className="footer-bottom ">
                <div className="container">
                    <div className="section-wrapper">
                        <p>&copy; 2023<Link to={"/"}>name</Link>Devloped by <a href="" target='_blanck'>Abderrahim.dev</a></p>
                        <div className="footer-bottom-list">
                            {
                                footerbottomList.map((item, key) => (
                                    <a href={item.link} key={key}>{item.text}</a>
                                ))
                            }
                        </div>
                    </div>
